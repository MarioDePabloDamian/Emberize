  ...
  return (
    <LegalLayout title="Política de privacidad" current="privacidad">
      ...
      <ul>
        ...
        <li>
          <strong>Datos de voz:</strong> si utilizas la demo del asistente de voz, el proveedor
      ...
      <ul>
        ...
        <li>
          <strong>Demo de voz</strong> — base legal: consentimiento al usar el micrófono y
      ...
      <ul>
        <li>
          <strong>GoHighLevel / LeadConnector</strong> — formulario, CRM, analítica y widget
          de voz embebido.
        </li>
        <li>
