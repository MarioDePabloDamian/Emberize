...
export default function CookiesPage() {
  return (
    <LegalLayout title="Política de cookies" current="cookies">
      ...
      <p>
        Solo se activan si pulsas &quot;Aceptar todas&quot; en el banner de cookies o en la demo
        de voz.
      </p>

      <h2>3. Cómo gestionar las cookies</h2>
      <ul>
        <li>Usa el banner al entrar en la web: &quot;Aceptar todas&quot; o &quot;Solo necesarias&quot;.</li>
        <li>
